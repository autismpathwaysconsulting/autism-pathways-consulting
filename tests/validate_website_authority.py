...
PAGE_REQUIREMENTS: Mapping[str, tuple[Requirement, ...]] = {
    ...
    "pay/index.html": (
        Requirement("suitability", r"\bsuitability\b.{0,80}\bavailability\b"),
        Requirement("permission_before_payment", r"\bpermission to pay\b"),
        Requirement("rm350_methods", r"\bmaybank\b.{0,180}\bduitnow qr\b.{0,220}\bwise\b"),
        Requirement("not_automatic", r"\bdoes not automatically confirm a booking\b|\bnot automatic booking confirmation\b"),
        Requirement("manual_after_verification", r"\bverifies the payment\b.{0,120}\bconfirms the booking\b"),
    ),
}
