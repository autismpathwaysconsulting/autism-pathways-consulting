...
PAGE_REQUIREMENTS: Mapping[str, tuple[Requirement, ...]] = {
    "services.html": (
        ...
        Requirement("home_whatsapp", r"\bwhatsapp clarification during the active programme\b"),
        Requirement("home_checkin", r"\bno additional post-programme check-in\b"),
    ...
    "terms.html": (
        ...
        Requirement("manual_after_verification", r"\bverifies payment before confirming\b"),
        Requirement("home_price", r"\brm\s*1,?800\b"),
        Requirement("home_sessions", r"\bfour(?: 60-minute(?: online)?)? sessions\b"),
        Requirement("home_frequency", r"\bonce every two weeks\b"),
        Requirement("home_whatsapp", r"\bwhatsapp clarification about the agreed plan\b"),
        Requirement("home_checkin", r"\bno additional post-programme check-in\b"),
    ),
    "pay/index.html": (
        Requirement("session_name", r"\bone-concern parent session\b"),
