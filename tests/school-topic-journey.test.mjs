...
function setup() {
  const fields = {};
  for (const id of ['school-training-form','school-whatsapp-link','sf-success','sf-name','sf-school','sf-role','sf-phone','sf-message','sf-topic','school-topic-0','school-topic-1','school-topic-2']) {
