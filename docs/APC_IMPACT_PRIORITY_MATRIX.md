...
1. **Clear problem-to-offer routing**
   - Free call answers fit/routing only.
   - One-Concern handles one defined repeated concern.
   - Home Implementation handles implementation/review over time.
...
3. **Implementation between sessions**
   - Small, bounded observations.
   - Review whether the plan was actually used.
   - Adjust rather than assuming the first idea was correct.

4. **Follow-up and maintenance**
   - 7-day clarification for One-Concern.
   - 20–30 minute maintenance check around one month after Home Implementation.

5. **Boundaries and response expectations**
   - What WhatsApp is for.
   - Expected response window.
   - No emergencies/crisis support.
   - No unlimited new concerns between sessions.

6. **Evidence collection**
   Track:
   - whether parent used the agreed plan,
...
8. **Operational workflow**
   ...
   - Practice Console reflects service and stage accurately.
...
- Metricool paid plan.
- Social handle rename.
- HRD Corp for parent services.
- MQA / CPD accreditation for parent services.
- Additional general certifications.
- Building many new packages/tiers.
- Annual subscription before demand exists.
- Complex dashboards visible to clients.
- Large resource library before core deliverables are proven.

## Separate school/educator impact gates

Necessary for the school lane:
- school-page visual QA,
- synthetic enquiry test,
...
A task is high-impact if it improves one or more of:
