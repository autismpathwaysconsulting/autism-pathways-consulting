...
### Problem solved
“I am not sure whether APC is the right route or what I should do next.”

### What the parent leaves knowing
- whether the concern is within APC's educational/consultative scope,
- which APC route, if any, fits best,
- whether another type of professional may be more appropriate,
- the next step if they choose to continue.

### Not included
- personalised strategy planning,
...
This remains a fit-and-routing call.
...
- selected APC public resources,
- One-Minute Pattern Check,
- minimum-version strategy for difficult/busy days,
- Who Does What consistency note,
...
- Parent-School Alignment Note,
- selected existing APC resources,
- parent-approved Shareable Support Summary,
...
This is a process commitment, not a guarantee of child or family outcomes.

### Not included
- unlimited messaging,
- unlimited goal/topic changes,
- emergency/crisis support,
- diagnosis,
- regulated therapy/clinical services,
...
CJ's professional education can inform his general professional judgement, but third-party programmes/materials are not repackaged as APC parent services unless their current licences explicitly permit that use.
...
Do not convert these into pseudo-clinical outcome claims or guarantees.
